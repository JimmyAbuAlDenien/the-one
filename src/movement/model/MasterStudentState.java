 ...
 */
public class MasterStudentState {
    ...
    public MasterStudentState getNextState(boolean isLunch, boolean isVisited) {
    ...
    private void increaseStateCapacity(MasterStudentState.State state) {
        Boolean found = false;

        for (Tuple<MasterStudentState.State, Integer> updatedState : stateCapacity) {
            if(updatedState.getKey() == state) {
                Tuple<MasterStudentState.State, Integer> newState = new Tuple<MasterStudentState.State, Integer>(state, updatedState.getValue() + 1);
        ...
        if(!found) {
            stateCapacity.add(new Tuple<MasterStudentState.State, Integer>(state, 1));
        }
    }

    private void decreaseStateCapacity(MasterStudentState.State state) {
        for (Tuple<MasterStudentState.State, Integer> updatedState : stateCapacity) {
            if(updatedState.getKey() == state) {
                Integer val = (updatedState.getValue() > 0)? updatedState.getValue()-1 : 0;
                Tuple<MasterStudentState.State, Integer> newState = new Tuple<MasterStudentState.State, Integer>(state, val);
                stateCapacity.remove(updatedState);
                stateCapacity.add(newState);
                break;
            }
    ...
    private int[] removeFullStates(int[] probs) {
        ...
        LinkedList<MasterStudentState> allStates = getSystemStates();
        ...
        for (int i=0; i < allStates.size(); i++) {
            MasterStudentState stateToCheck = allStates.get(i);
    ...
    private Integer getStateCapacity(MasterStudentState.State state) {
        for (Tuple<MasterStudentState.State, Integer> updatedState : stateCapacity) {
            if(updatedState.getKey() == state) {
    ...
    public LinkedList<MasterStudentState> getSystemStates() {
        ...
        MasterStudentState lectureHall1 = new MasterStudentState(MasterStudentState.State.LectureHall1, case1, case2,case3, case4, new Coord(987.70,343.45), 200, 500, 500);
        ...
        MasterStudentState lectureHall2 = new MasterStudentState(MasterStudentState.State.LectureHall2, case5, case6,case7, case8, new Coord(707.16,447.99), 150, 500, 500);
        ...
        MasterStudentState lectureHall3 = new MasterStudentState(MasterStudentState.State.LectureHall3, case9, case10,case11, case12, new Coord(860.44,495.73), 100, 500, 500);
        ...
        MasterStudentState seminarHall1 = new MasterStudentState(MasterStudentState.State.SeminarHall1, case13, case14,case15, case16, new Coord(120.56,0.00), 50, 500, 500);
        ...
        MasterStudentState seminarHall2 = new MasterStudentState(MasterStudentState.State.SeminarHall2, case17, case18,case19, case20, new Coord(637.79,511.05), 50, 500, 500);
        ...
        MasterStudentState seminarHall3 = new MasterStudentState(MasterStudentState.State.SeminarHall3, case21, case22,case23, case24, new Coord(481.63,193.80), 50, 500, 500);
        ...
        MasterStudentState seminarHall4 = new MasterStudentState(MasterStudentState.State.SeminarHall4, case25, case26,case27, case28, new Coord(278.89,157.64), 50, 500, 500);
        ...
        MasterStudentState seminarHall5 = new MasterStudentState(MasterStudentState.State.SeminarHall5, case29, case30,case31, case32, new Coord(149.85,135.00), 50, 500, 500);
        ...
        MasterStudentState mainHall1 = new MasterStudentState(MasterStudentState.State.MainHall1, case33, case34,case35, case36, new Coord(814.56,368.49), 100, 0, 500);
        ...
        MasterStudentState mainHall2 = new MasterStudentState(MasterStudentState.State.MainHall2, case37, case38,case39, case40, new Coord(453.13,278.73), 100, 0, 500);
        ...
        MasterStudentState mainHall3 = new MasterStudentState(MasterStudentState.State.MainHall3, case41, case42,case43, case44, new Coord(257.52,223.94), 100, 0, 500);
        systemStates.add(mainHall2);
        ...
        MasterStudentState mensa = new MasterStudentState(MasterStudentState.State.Mensa, case45, case46,case47, case48, new Coord(548.61,393.59), 100, 300, 600);
        ...
        MasterStudentState entrance = new MasterStudentState(MasterStudentState.State.Enterance, case49, case50,case51, case52, new Coord(881.02,216.67), 10000000, 0, 0);
        ...
        MasterStudentState computerHall = new MasterStudentState(MasterStudentState.State.ComputerHall, case53, case54,case55, case56, new Coord(667.17,208.08), 200, 100, 600);
        ...
        MasterStudentState library = new MasterStudentState(MasterStudentState.State.Library, case57, case58,case59, case60, new Coord(147.56,291.82), 300, 300, 600);
