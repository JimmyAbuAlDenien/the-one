 ...
 */
public class MasterStudentState extends MINodeState {
...
//        System.out.println("isLunch: " + isLunch + " " + "isVisited: " + isLunch);
    ...
    public LinkedList<MINodeState> getSystemStates() {
        ...
        MINodeState lectureHall1 = new MasterStudentState(State.LectureHall1, case1, case2,case3, case4, new Coord(987.70,343.45), 200, 500, 500);
        ...
        MINodeState lectureHall2 = new MasterStudentState(State.LectureHall2, case5, case6,case7, case8, new Coord(707.16,447.99), 150, 500, 500);
        ...
        MINodeState lectureHall3 = new MasterStudentState(State.LectureHall3, case9, case10,case11, case12, new Coord(860.44,495.73), 100, 500, 500);
        ...
        MINodeState seminarHall1 = new MasterStudentState(State.SeminarHall1, case13, case14,case15, case16, new Coord(120.56,0.00), 50, 500, 500);
        ...
        MINodeState seminarHall2 = new MasterStudentState(State.SeminarHall2, case17, case18,case19, case20, new Coord(637.79,511.05), 50, 500, 500);
        ...
        MINodeState seminarHall3 = new MasterStudentState(State.SeminarHall3, case21, case22,case23, case24, new Coord(481.63,193.80), 50, 500, 500);
        ...
        MINodeState seminarHall4 = new MasterStudentState(State.SeminarHall4, case25, case26,case27, case28, new Coord(278.89,157.64), 50, 500, 500);
        ...
        MINodeState seminarHall5 = new MasterStudentState(State.SeminarHall5, case29, case30,case31, case32, new Coord(149.85,135.00), 50, 500, 500);
        ...
        MINodeState mainHall1 = new MasterStudentState(State.MainHall1, case33, case34,case35, case36, new Coord(814.56,368.49), 100, 0, 500);
        ...
        MINodeState mainHall2 = new MasterStudentState(State.MainHall2, case37, case38,case39, case40, new Coord(453.13,278.73), 100, 0, 500);
        ...
        MINodeState mainHall3 = new MasterStudentState(State.MainHall3, case41, case42,case43, case44, new Coord(257.52,223.94), 100, 0, 500);
        ...
        MINodeState mensa = new MasterStudentState(State.Mensa, case45, case46,case47, case48, new Coord(548.61,393.59), 100, 300, 600);
        ...
        MINodeState entrance = new MasterStudentState(State.Entrance, case49, case50,case51, case52, new Coord(881.02,216.67), 10000000, 0, 0);
        ...
        MINodeState computerHall = new MasterStudentState(State.ComputerHall, case53, case54,case55, case56, new Coord(667.17,208.08), 200, 100, 600);
        ...
        MINodeState library = new MasterStudentState(State.Library, case57, case58,case59, case60, new Coord(147.56,291.82), 300, 300, 600);
