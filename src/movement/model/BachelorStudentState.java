 ...
 */
public class BachelorStudentState {
    ...
    public BachelorStudentState(State state, int[] startProbability, int[] lunchProbability,
    ...
    public BachelorStudentState getNextState(boolean isLunch, boolean isVisited) {
    ...
    private void increaseStateCapacity(BachelorStudentState.State state) {
        Boolean found = false;

        for (Tuple<BachelorStudentState.State, Integer> updatedState : stateCapacity) {
            if(updatedState.getKey() == state) {
                Tuple<BachelorStudentState.State, Integer> newState = new Tuple<BachelorStudentState.State, Integer>(state, updatedState.getValue() + 1);
        ...
        if(!found) {
            stateCapacity.add(new Tuple<BachelorStudentState.State, Integer>(state, 1));
        }
    }

    private void decreaseStateCapacity(BachelorStudentState.State state) {
        for (Tuple<BachelorStudentState.State, Integer> updatedState : stateCapacity) {
            if(updatedState.getKey() == state) {
                Integer val = (updatedState.getValue() > 0)? updatedState.getValue()-1 : 0;
                Tuple<BachelorStudentState.State, Integer> newState = new Tuple<BachelorStudentState.State, Integer>(state, val);
                stateCapacity.remove(updatedState);
                stateCapacity.add(newState);
                break;
            }
    ...
    private int[] removeFullStates(int[] probs) {
        ...
        LinkedList<BachelorStudentState> allStates = getSystemStates();
        ...
        for (int i=0; i < allStates.size(); i++) {
            BachelorStudentState stateToCheck = allStates.get(i);
    ...
    private Integer getStateCapacity(BachelorStudentState.State state) {
        for (Tuple<BachelorStudentState.State, Integer> updatedState : stateCapacity) {
            if(updatedState.getKey() == state) {
    ...
    public static BachelorStudentState getStateByName(State state) {
        for (BachelorStudentState systemState : getSystemStates()) {
    ...
    // TODO: Bachelor students will have different set of states (ex: always 0 for seminar rooms)
    public static LinkedList<BachelorStudentState> getSystemStates() {
        LinkedList<BachelorStudentState> systemStates = new LinkedList<>();
        ...
        BachelorStudentState lectureHall1 = new BachelorStudentState(BachelorStudentState.State.LectureHall1, case1, case2,case3, case4, new Coord(987.70,343.45), 200, 500, 500);
        ...
        BachelorStudentState lectureHall2 = new BachelorStudentState(BachelorStudentState.State.LectureHall2, case5, case6,case7, case8, new Coord(707.16,447.99), 150, 500, 500);
        ...
        BachelorStudentState lectureHall3 = new BachelorStudentState(BachelorStudentState.State.LectureHall3, case9, case10,case11, case12, new Coord(860.44,495.73), 100, 500, 500);
        ...
        BachelorStudentState seminarHall1 = new BachelorStudentState(BachelorStudentState.State.SeminarHall1, case13, case14,case15, case16, new Coord(120.56,0.00), 50, 500, 500);
        ...
        BachelorStudentState seminarHall2 = new BachelorStudentState(BachelorStudentState.State.SeminarHall2, case17, case18,case19, case20, new Coord(637.79,511.05), 50, 500, 500);
        ...
        BachelorStudentState seminarHall3 = new BachelorStudentState(BachelorStudentState.State.SeminarHall3, case21, case22,case23, case24, new Coord(481.63,193.80), 50, 500, 500);
        ...
        BachelorStudentState seminarHall4 = new BachelorStudentState(BachelorStudentState.State.SeminarHall4, case25, case26,case27, case28, new Coord(278.89,157.64), 50, 500, 500);
        ...
        BachelorStudentState seminarHall5 = new BachelorStudentState(BachelorStudentState.State.SeminarHall5, case29, case30,case31, case32, new Coord(149.85,135.00), 50, 500, 500);
        ...
        BachelorStudentState mainHall1 = new BachelorStudentState(BachelorStudentState.State.MainHall1, case33, case34,case35, case36, new Coord(814.56,368.49), 100, 0, 500);
        ...
        BachelorStudentState mainHall2 = new BachelorStudentState(BachelorStudentState.State.MainHall2, case37, case38,case39, case40, new Coord(453.13,278.73), 100, 0, 500);
        ...
        BachelorStudentState mainHall3 = new BachelorStudentState(BachelorStudentState.State.MainHall3, case41, case42,case43, case44, new Coord(257.52,223.94), 100, 0, 500);
        systemStates.add(mainHall2);
        ...
        BachelorStudentState mensa = new BachelorStudentState(BachelorStudentState.State.Mensa, case45, case46,case47, case48, new Coord(548.61,393.59), 100, 300, 600);
        ...
        BachelorStudentState entrance = new BachelorStudentState(BachelorStudentState.State.Enterance, case49, case50,case51, case52, new Coord(881.02,216.67), 10000000, 0, 0);
        ...
        BachelorStudentState computerHall = new BachelorStudentState(BachelorStudentState.State.ComputerHall, case53, case54,case55, case56, new Coord(667.17,208.08), 200, 100, 600);
        ...
        BachelorStudentState library = new BachelorStudentState(BachelorStudentState.State.Library, case57, case58,case59, case60, new Coord(147.56,291.82), 300, 300, 600);
