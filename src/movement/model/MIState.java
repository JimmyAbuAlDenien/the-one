...
public class MIState {
    ...
    public static LinkedList<MIState> getSystemStates() {
        ...
        MIState lectureHall1 = new MIState(MIState.State.LectureHall1, case1, case2,case3, case4, new Coord(987.70,343.45));
        ...
        MIState lectureHall2 = new MIState(MIState.State.LectureHall2, case5, case6,case7, case8, new Coord(707.16,447.99));
        ...
        MIState lectureHall3 = new MIState(MIState.State.LectureHall3, case9, case10,case11, case12, new Coord(860.44,495.73));
        ...
        MIState seminarHall1 = new MIState(MIState.State.SeminarHall1, case13, case14,case15, case16, new Coord(120.56,0.00));
        ...
        MIState seminarHall2 = new MIState(MIState.State.SeminarHall2, case17, case18,case19, case20, new Coord(637.79,511.05));
        ...
        MIState seminarHall3 = new MIState(MIState.State.SeminarHall3, case21, case22,case23, case24, new Coord(481.63,193.80));
        ...
        MIState seminarHall4 = new MIState(MIState.State.SeminarHall4, case25, case26,case27, case28, new Coord(278.89,157.64));
        ...
        MIState seminarHall5 = new MIState(MIState.State.SeminarHall5, case29, case30,case31, case32, new Coord(149.85,135.00));
        ...
        MIState mainHall1 = new MIState(MIState.State.MainHall1, case33, case34,case35, case36, new Coord(814.56,368.49));
        ...
        MIState mainHall2 = new MIState(MIState.State.MainHall2, case37, case38,case39, case40, new Coord(453.13,278.73));
        ...
        MIState mainHall3 = new MIState(MIState.State.MainHall3, case41, case42,case43, case44, new Coord(257.52,223.94));
        systemStates.add(mainHall2);
        ...
        MIState mensa = new MIState(MIState.State.Mensa, case45, case46,case47, case48, new Coord(548.61,393.59));
        ...
        MIState entrance = new MIState(MIState.State.Enterance, case49, case50,case51, case52, new Coord(881.02,216.67));
        ...
        MIState computerHall = new MIState(MIState.State.ComputerHall, case53, case54,case55, case56, new Coord(667.17,208.08));
        ...
        MIState library = new MIState(MIState.State.Library, case57, case58,case59, case60, new Coord(147.56,291.82));
